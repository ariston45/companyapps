    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">Aktifitas Ujian Hari Ini</h3>
          <div class="box-tools pull-right">
            <a href="{{ route('instansi.tambah-instansi') }}">
              <button type="button" class="btn btn-xs btn-flat btn-primary"><i class="fa fa-plus"></i> Tambahkan Instansi</button>
            </a>
          </div>
        </div>
        <div class="box-body">
  ...
  <script>
    $(document).ready(function() {
			tabel_jadwal = $('#tabel_instansi').DataTable({
				...
				lengthChange: true,
        ajax: {
					"url": "{!! route("datatables.source-instansi") !!}",
					"type" : "POST",
				},
				columns: [
