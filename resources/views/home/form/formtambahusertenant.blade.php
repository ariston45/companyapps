...
<div class="col-md-12">
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title"><i class="fa fa-edit" aria-hidden="true"></i> Update Data Guru</h3>
      <div class="pull-right">
        <a href="{{ url('instansi/detail-instansi/'.$ids) }}">
      ...
      <form class="form-horizontal" id="form-user" autocomplete="off">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="no_induk" name="no_induk" placeholder="NIP" value="">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="" autocomplete="new-password">
            </div>
          </div>
          <div class="form-group">
...
<script>
  $(document).ready(function (){
    $("#save").click(function() {
      ...
      $.ajax({
        type: "POST",
        url: "{{ url('crud/tambah-user-tenant') }}",
        data: formData,
