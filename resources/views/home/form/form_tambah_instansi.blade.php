	...
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<div class="box-body">
				<div class="col-sm-12">
					<div class="col-sm-12">
            <form id="form-jadwal" action="{{ route('crud.create-instansi') }}" class="form-horizontal" enctype="multipart/form-data" method="POST">
              {{ csrf_field() }}
                  ...
                  <input type="text" name="nama_instansi" class="form-control" required>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="email_instansi" class="form-control">
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="telepon_instansi" class="form-control">
									</select>
								</div>
							</div>
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" readonly name="image2">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<button type="reset" class="btn btn-sm btn-default" id="reset">Bersihkan</button>
								</div>
							</div>
              <div class="form-group">
                <label for="save" class="col-sm-3 control-label">&nbsp</label>
			...
			$.ajax({
				...
				success: function(data) {
					if (data.success == 1) {
						...
						document.getElementById('voucher-jml').innerHTML = data.pre_alokasi;
					}else{
